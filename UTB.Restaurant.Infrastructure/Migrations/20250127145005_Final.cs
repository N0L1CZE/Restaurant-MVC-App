        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 0, "7a8d96fd-5918-441b-b800-cbafa99de97b", "customer@customer.cz", true, "Customerek", "Customerovy", true, null, "CUSTOMER@CUSTOMER.CZ", "CUSTOMER", "AQAAAAEAACcQAAAAEOzeajp5etRMZn7TWj9lhDMJ2GSNTtljLWVIWivadWXNMz8hj6mZ9iDR+alfEUHEMQ==", null, false, "MAJXOSATJKOEM4YFF32Y5G2XPR5OFEL6", false, "customer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Prostě Pizza!", "/img/products/product1.jpg", "Pizza", 150.0 },
                    { 2, "Jarní vietnamské závitky, prostě mňamka", "/img/products/product2.jpg", "Závitky", 80.0 },
                    { 3, "Prostě kachna", "/img/products/product3.jpg", "Kachna se zelím a bramborovým knedlíkem", 130.0 }
                });
